...
knitr::opts_knit$set(root.dir = "~/Box Sync/Documents/Classes/TA/ExpDesign/topdownattentiondata/")
```
...
```{r}
setwd("~/Box Sync/Documents/Classes/TA/ExpDesign/topdownattentiondata/")

# In the raw data, there is one file per subject. This is making a list of all the files we need to read in
file_list <- list.files(path = "~/Box Sync/Documents/Classes/TA/ExpDesign/topdownattentiondata/", pattern = "\\.txt$")
...
#Performace = performance (1=correct, 2=incorrect, 3=timeout)
#Subject
```
...
```{r}
write_csv(dataset, "~/Box Sync/Documents/Classes/TA/ExpDesign/topdownattention.csv")
...
wide_bysubject_level_cue <- wide_bysubject_level_cue %>% select(-Timeout)
